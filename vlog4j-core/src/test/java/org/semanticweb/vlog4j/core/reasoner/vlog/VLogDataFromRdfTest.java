...
public class VLogDataFromRdfTest {
	...
	private final List<List<Term>> expectedTernaryQueryResult = Arrays.asList(
	...
	public void testLoadDataFomRdfString()
		...
		assertEquals(this.expectedTernaryQueryResult, queryResult);
		assertEquals(queryResult, queryResultZipped);

		final List<List<Term>> queryResultsT = getTernaryQueryResults(vLog, "t");
